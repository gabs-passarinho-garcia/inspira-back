...
export class UserRepository {
    ...
    public static async create(data: { user: User }): Promise<void> {
        await PrismaHandler.client.user.create({
            data: {
                id: data.user.id,
                name: data.user.name,
    ...
    public static async update(data: { user: User }): Promise<void> {
        await PrismaHandler.client.user.update({
            where: {
                id: data.user.id,
            },
            data: {
